...
{
	const unsigned char serialized1[] = {'\x01', '\x02', '\x00', '\x03', '1', '2', '3'};
	const unsigned char serialized2[] = {'\x02', '\x04', '\x00', '\x00'};
	const unsigned char serialized3[] = {'\x04', '\x02', '\x00', '\x03', '1', '2', '3',
										 '\x02', '\x02', '\xff', '\xff', '1', '3', '3', '7'};
	const unsigned char serialized4[] = {'\x04', '\x02', '\x00', '\x03', '1', '2', '3',
...
{
	const unsigned char serialized[] = {'\x04', '\x02', '\x00', '\x03', '1', '2', '3',
										 '\x02', '\x02', '\x00', '\x04', '1', '3', '3', '7'};
